...
namespace TodoList
{
    ...
    {
        public ViewModel.TodoManage AllTodo { get; set; }
        ...
        public App()
        {
            ...
            this.AllTodo = new ViewModel.TodoManage();
        }
        ...
        private async void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            using (var session = new ExtendedExecutionSession())
            {
                ...
                // Upload Data
                ViewModel.TodoManage OrzTodo = Application.Current.Resources["Orz"] as ViewModel.TodoManage;
