...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	Animation* mouse = Animation::create();
	totalFrames = 8;
	for (int i = 0; i < totalFrames; i++)
	{
		sprintf(frameName, "mouse-%d.png", i);
		mouse->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(frameName));
	}
	mouse->setDelayPerUnit(0.1);
	AnimationCache::getInstance()->addAnimation(mouse, "mouseAnimation");
